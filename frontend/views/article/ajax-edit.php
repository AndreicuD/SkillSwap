...
<?php $form = ActiveForm::begin([
    ...
    'action' => ['article/update', 'id' => $model->public_id, 'page' => 'user'], // Specify the route to the create action
    'method' => 'post',
]); ?>
...
<p class="card-text text-center" style="margin-bottom: 0; align-content: center;"><b><?= Yii::t('app', 'Price: ') ?></b></p>
