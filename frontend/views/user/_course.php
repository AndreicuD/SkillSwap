...
<div class="card-image">
    ...
    <button 
        ...
        data-modal_url="<?=Url::to(['course/ajax-delete', 'public_id' => $model->public_id]); ?>" >
        <?=$trash_svg?>
    </button>
</div>
<div class="card-body">
...
<div class="btn-group w-100" style="border: none;">
    <button 
        ...
        data-modal_url="<?=Url::to(['course/ajax-stats', 'public_id' => $model->public_id]); ?>" >
        <?= Yii::t('app', 'Stats') ?>
    </button>
    <?= Html::a(Yii::t('app', 'Edit Course'),['/course/edit', 'public_id' => $model->public_id],['class' => ['card-button btn btn-primary']]) ?>
</div>
