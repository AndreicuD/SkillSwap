...
<div class="card" style="width: 100%;">
    <div class="card-header group_together">
        ...
        <div class="group_together">
            ...
            <?= Html::a(Yii::t('app', 'Edit Article'),['/article/edit'],['class' => ['btn btn-primary rotate_on_hover scale_on_hover']]) ?>
        </div>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer" style="border-top: 0;">
        <div class="group_together">
            ...
            <p class="card-text" style="margin-bottom: 0; align-content: center;"><b><?= Yii::t('app', 'Category: ') ?></b> <?= $model->category ?></p>
