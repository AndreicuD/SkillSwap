<?php
/**
 * @var string $type either 'article' or 'quiz'
 * @var string $title the title of the element
 */
...
<div class="course-element-card" style="border: 1px solid #ccc; border-radius: 8px; padding: 16px; text-align: center; width: 200px; margin: 10px;">
    <div class="card-icon" style="margin-bottom: 12px;">
        <?= $svg[$type] ?? '' ?>
    </div>
